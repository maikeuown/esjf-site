...
import { Megaphone, Calendar, Pin, ArrowRight, Clock } from 'lucide-react';
              ...
              <Link key={aviso.id} href={`/avisos/${aviso.slug}`} className="group">
                <Card className="h-full card-glow-lift-pulse border-border/50 cursor-pointer overflow-hidden">
                  <CardContent className="p-6">
                    ...
                    {aviso.excerpt && (
                      <p className="text-sm text-muted-foreground mb-4 line-clamp-3 text-glow">{aviso.excerpt}</p>
                    )}
                    <div className="flex flex-wrap gap-3 text-sm text-muted-foreground mt-auto">
                      ...
                      {aviso.expires_at && (
                        <span className="flex items-center gap-1">
                          ...
                          {formatDate(new Date(aviso.expires_at))}
                        </span>
                      )}
                    </div>
                  </CardContent>
          ...
          <CardContent className="p-12 text-center">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-muted-foreground">
                Não há avisos importantes a serem exibidos. Volte mais tarde.
              </p>
            </div>
          </CardContent>
        </Card>
